/-!
# minimal-model-program-canonical-lane Lean migration boundary
...
`MinimalModelProgramCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "minimal-model-program-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/minimal-model-program-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Minimal Model Program: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["algebraic-geometry", "birational-geometry", "mathematical-proof", "minimal-model-program", "reproducibility", "manifold-constrained", "canonical-lane", "local-to-global"]
