# Minimal Model Program — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/minimal-model-program-canonical-lane-mathlib.git
cd minimal-model-program-canonical-lane-mathlib
lake exe
lake build
```
